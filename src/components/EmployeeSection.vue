    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
          ...
          <p>Národný golfový klub bol založený 16. mája 1999. 18. júna 1999 bolo slávnostne otvorené zázemie klubu vo forme provizórneho objektu. V
...
<script>
import EmployeeSlideshow from '../components/EmployeeSlideshow.vue';
export default {
  components: {EmployeeSlideshow}
}
</script>